...
public class Youtube {
    private static final String PATH = "my_videos";
    ...
    public Subtitle downloadSubtitle(String videoId) {
        List<SubtitlesInfo> subtitlesInfo = this.requestDetails(videoId).subtitlesInfo();
        
//        for (SubtitlesInfo info : subtitlesInfo) {
        RequestSubtitlesDownload request = new RequestSubtitlesDownload(subtitlesInfo.getFirst())
                // optional
...
//        }
    ...
    public VideoInfo requestDetails(String videoId) {
    ...
    public VideoResult download(String videoId) {
        VideoInfo videoInfo = this.requestDetails(videoId);
        ...
        return new VideoResult(videoId, videoInfo, response.data());
    }
